...
int main()
{
    ...
    while (run_server)
    {
        ...
        for (int descriptor = 0/*, i = 0*/; descriptor <= max_sd && desc_ready > 0; descriptor++)
        {
            ...
            if (FD_ISSET(descriptor, &working_set))
            {
                ...
                else
                {
                    ...
                    while (true)
                    {
                        ...
                        messages_count += 1;
                        std::cout << "count after incrementation " << messages_count << std::endl;
                        if (messages_count == 9)
                        {
                        	std::cout << "messages limit" << std::endl;
                        	close_conn = true;
                        	break;
                        }
